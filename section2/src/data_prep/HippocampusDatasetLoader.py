...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # ANSWER:
        # 1. Class Representation: Ensures each class is represented by a unique numerical value.
        # 2. Memory Efficiency: Integers use less memory than strings or floats.
        # 3. Performance: Integer operations are faster, potentially improving model performance.
