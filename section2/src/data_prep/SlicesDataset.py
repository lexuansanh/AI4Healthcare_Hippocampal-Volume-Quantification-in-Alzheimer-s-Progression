...
class SlicesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_no, slice_no = slc  # Load information of that slice

        # Load and reshape slice image
        slice_image = self.data[image_no]['image'][slice_no][None, :]

        # Load and reshape slice segmentation
        slice_seg = self.data[image_no]['seg'][slice_no][None, :]

        # Convert image and seg to torch tensors
